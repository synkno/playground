...
class DioF0:
    ...
    def interpolate_f0(self,f0):
        ...
        nzindex = np.nonzero(f0)[0]#非0的f0的全部索引
        data = f0[nzindex]#非0的f0的全部数据
        ...
        time_org 是采样数据中的x，
        data 是采样数据中的y
        time_frame 是要插值的x',  x' 从x中找到两个数字 xl, xr 关系是 xl < x' < xr, 然后用对应的yl,yr 线性计算插值的结果。
        """
    ...
    def compute_f0_uv(self,wav,p_len=None):
        ...
        #StoneMask 则利用语音的频谱信息（尤其是谐波结构）来重新估计 F0，使其更贴近真实音高
